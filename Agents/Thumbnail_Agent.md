...
A concept cannot win merely because it is `complementary`. It must also pass Visual Resolvability, Primary-Promise Proximity, Whole-Video Promise Coverage, Instant Visual Comprehension / Renderability, Focal-Load, and medical-safety checks.
